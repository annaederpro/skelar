...
export function LandingFooterCta() {
  return (
    <section className="bg-sea-soft px-6 py-20 text-center text-ink">
      <h2 className="font-heading text-[26px] font-semibold">Зроби перший крок без поспіху</h2>
      <p className="mx-auto mt-2 max-w-sm text-[14.5px] text-ink-soft">
        Зареєструйся за кілька секунд, вкажи свій ресурс і почни рухатися вперед із легкістю.
      </p>
      <Link
